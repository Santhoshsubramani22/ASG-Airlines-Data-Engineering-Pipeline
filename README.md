...
│
├── documentation/
│   └── ASG_Airlines_Data_Engineering_Report.docx
│
├── architecture/
...
5. Clean and Standardize Data
        |
        v
6. Validate IDs and Relationships
        |
        v
7. Calculate Flight Duration
        |
        v
8. Identify Overnight Flights
        |
        v
9. Create Routes and
   Time-Based Features
...
Although the current implementation uses Python and Excel, the architecture can be extended to a cloud-based environment.
...
## Step 2 – Place the Source Dataset
...
or execute the Python pipeline:
...
The generated analytical datasets will be available under:
...
Import the generated CSV files into Power BI and establish the documented relationships.

## Step 6 – Refresh Dashboard

Refresh the Power BI model to display the latest analytical results.
